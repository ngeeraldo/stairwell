...
message, before the call, say briefly what you are having built and that it is
under way. **The friend must be told**, because with no card appearing there is
otherwise no sign anything happened — and with no preview to describe the
dashboard for them, your sentence is the only description they get. Keep it to
a sentence, not a walkthrough.
