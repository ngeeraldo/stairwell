...
- **The change summary** from the version that shipped — what they asked for,
  in their own words.
...
**Say briefly what it does.** There is no preview and nothing was confirmed in
advance — this message is the first look they get. Name what it actually
shows, in one plain clause, using only what shipped and the change summary.
