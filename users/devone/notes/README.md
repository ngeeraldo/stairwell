...
**Never put devone's data in here.** This folder is committed to the repo.
...
Two sections reach devone and two do not. `lib/build/notes.ts` enforces that
...
## What shipped
Product-level. What devone can now see or do that they could not before.
...
instruction rather than a disclosure: it never reaches devone. Take it back
