// users/run3/tests/dashboard.test.ts
//
...
describe('users/run3', () => {
  ...
  it('puts the query result in the rendered output', async () => {
    const json = JSON.stringify(
      await Dashboard({ slug: 'run3', db, today: '2026-03-15', timeZone: 'UTC' }),
    )
  ...
  it('renders the day the FRIEND is having, not the host', () => {
    ...
    // of it for whatever run3's dashboard shows dates on.
