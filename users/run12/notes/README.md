...
**Never put run12's data in here.** This folder is committed to the repo.
...
Two sections reach run12 and two do not. `lib/build/notes.ts` enforces that
...
## What shipped
Product-level. What run12 can now see or do that they could not before.
...
instruction rather than a disclosure: it never reaches run12. Take it back
