...
//
// run9's dashboard. NOT BUILT YET — this is the scaffold, and everything
// below is meant to be deleted rather than extended.
//
// Build toward users/run9/spec.md — pulled from the confirmed spec by
...
// built, users/run9/current.md becomes the next agent's orientation
